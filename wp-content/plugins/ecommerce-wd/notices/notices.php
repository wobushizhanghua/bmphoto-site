...
class WDE_Notices {
  protected $prefix = 'wde';
  protected $plugin_url = WD_E_URL;
  protected $plugin_version = "wde_version";
  protected $plugin_name = 'Ecommerce WD';
        ...
        if ($admin_display_check == 0 && strtotime($admin_display_start) <= strtotime($current_date)) {
          ...
          if (strpos($slug, 'promo') === FALSE) {
            ...
            echo '</div>';
				...
				if ($output_css) {
					wp_enqueue_style($this->prefix . '-admin-notices', $this->plugin_url . '/notices/notices.css', array(), get_option($this->plugin_version));
				}
			}
		}
	}
  ...
  public function wd_admin_notices() {
    ...
    $notices['two_week_review'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://wordpress.org/support/view/plugin-reviews/ecommerce-wd?filter=5" target="_blank">' . __('Sure! I\'d love to!', $this->prefix) . '</a></li>
    ...
    $notices['one_week_support'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="https://web-dorado.com/wordpress-ecommerce/installing.html">' . __('Check out User Guide', $this->prefix) . '</a></li>
                <li><span class="dashicons dashicons-sos"></span><a target="_blank" href="https://web-dorado.com/forum/ecommerce.html">' . __('Get Some Help', $this->prefix) . '</a></li>
