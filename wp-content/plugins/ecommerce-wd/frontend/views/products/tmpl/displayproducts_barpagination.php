...
wp_enqueue_script('wde_' . $this->_layout . '_barpagination');
wp_enqueue_style('wde_' . $this->_layout . '_barpagination');
    ...
    <form name="wd_shop_form_pagination" class="form-horizontal" action="" method="POST">
      <div class="row">
        <div class="col-md-8 text-center">
          <ul class="wd_shop_pagination pagination pagination-sm">
            ...
            for ($i = $pagination->start; $i <= $pagination->stop; $i++) {
              ...
              ?>
            <li class="<?php echo $page_class; ?>">
              <a href="#" onclick="<?php echo $page_on_click; ?> return false;"><?php echo $i ?></a>
            </li>
              <?php
            }
        ...
        <div class="col-md-4 text-center">
          ...
          ?>
          <select name="items_per_page" class="form-control input-sm" onchange="wdShop_formPagination_onItemsPerPageChange(event, this);">
