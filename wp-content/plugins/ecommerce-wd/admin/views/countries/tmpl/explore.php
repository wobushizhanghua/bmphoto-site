...
$rows = $this->rows;
$count = wp_count_terms('wde_countries', array('name__like' => WDFSession::get('search_name', '')));
$pager_number = 0;
?>
  ...
  <table class="adminlist table table-striped widefat fixed pages">
    <thead>
      <tr>
        ...
        <?php echo WDFHTML::wd_ordering('code', $sort_by, $sort_order, __('Country code', 'wde')); ?>
      </tr>
    </thead>
    <tbody>
      <?php
