...
$count = wp_count_terms('wde_shippingmethods', array('name__like' => WDFSession::get('search_name', '')));
  ...
  <table class="adminlist table table-striped widefat fixed pages">
    <thead>
      <tr>
        ...
        <?php echo WDFHTML::wd_ordering('price', $sort_by, $sort_order, __('Price', 'wde')); ?>
      </tr>
    </thead>
    <tbody>
      <?php
