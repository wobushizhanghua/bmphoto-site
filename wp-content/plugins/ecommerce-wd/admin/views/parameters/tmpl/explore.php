...
$count = wp_count_terms('wde_parameters', array('name__like' => WDFSession::get('search_name', '')));
$pager_number = 0;
  ...
  <table class="adminlist table table-striped widefat fixed pages">
    <thead>
      <tr>
        ...
        <?php echo WDFHTML::wd_ordering('type', $sort_by, $sort_order, __('Type', 'wde')); ?>
        <?php echo WDFHTML::wd_ordering('required', $sort_by, $sort_order, __('Required', 'wde')); ?>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr class="row<?php echo $i % 2; ?> <?php echo $alternate; ?>"
          itemId="<?php echo $row->id; ?>"
                ...
                itemDefaultValuesIds='<?php echo $row->default_values_ids; ?>'
        ...
        <td class="col_required">
          <?php echo WDFHTML::icon_boolean_inactive($row->id, $row->required, 'required', 'notrequired', TRUE); ?>
        </td>
      </tr>
        <?php
        }
