...
$wp_customize->add_control(
    new Supermag_Customize_Message_Control(
        ...
        array(
            'section'   => 'supermag-feature-category',
            'description'   => sprintf( __( 'Note : If problem in image size, please follow the this %s documentation %s', 'supermag' ), '<a href="http://www.doc.acmethemes.com/supermag/" target="_blank">','</a>' ),
