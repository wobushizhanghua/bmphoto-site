  ...
  <div class="wrap free" id="main_<?php echo $currenttab; ?>_page">
    ...
    <?php 
      ...
      if ( isset( $_GET['settings-updated']) ){
        echo "<div class='updated'><p>".__('Theme settings updated successfully', "sauron")."</p></div>";
      }
...
function wdwt_admin_scripts(){
  ...
  wp_localize_script( WDWT_VAR.'_admin_element_view_script', 'wdwt_slide_warning', __("You cannot delete the last slide! Try to turn off the slider", "sauron") );
