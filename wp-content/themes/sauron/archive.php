...
<?php if ( is_active_sidebar( 'sidebar-1' ) ) { ?>
	...
	<?php $post = $posts[0]; ?>
		...
		<?php  if (is_category()) { ?>
		<h2 class="styledHeading"><?php _e('Archive For The ', "sauron"); ?>&ldquo;<?php single_cat_title(); ?>&rdquo; <?php _e('Category', "sauron"); ?></h2>
	 	<?php  } elseif( is_tag() ) { ?>
		<h2 class="styledHeading"><?php _e('Posts Tagged ', "sauron"); ?>&ldquo;<?php single_tag_title(); ?>&rdquo;</h2>
		<?php  } elseif (is_day()) { ?>
